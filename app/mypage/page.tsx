    ...
    <main className="min-h-screen bg-[#09090f] text-white px-4 py-8">
      <div className="max-w-6xl mx-auto">
        ...
        <section className="bg-[#151522] border border-white/10 rounded-2xl p-6 mb-6">
          <div className="flex items-center justify-between gap-6 flex-wrap">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <Link href="/mypage/profile" className="text-center rounded-xl bg-purple-600 hover:bg-purple-500 px-4 py-3 font-bold">
                프로필 사진 변경
              </Link>

              <Link href="/mypage/nickname" className="text-center rounded-xl bg-green-600 hover:bg-green-500 px-4 py-3 font-bold">
                닉네임 변경
              </Link>

              <Link href="/mypage/titles" className="text-center rounded-xl bg-yellow-500 hover:bg-yellow-400 text-black px-4 py-3 font-bold">
                칭호 변경
              </Link>

              <Link href="/mypage/inventory" className="text-center rounded-xl bg-blue-600 hover:bg-blue-500 px-4 py-3 font-bold">
                내 아이템
              </Link>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Link href="/mypage/posts" className="bg-[#151522] border border-white/10 rounded-2xl p-6 hover:bg-[#1c1c2b] transition">
            <h2 className="text-2xl font-bold mb-2">내가 쓴 게시글</h2>
            <p className="text-zinc-400">내가 작성한 게시글 전체 보기</p>
          </Link>

          <Link href="/mypage/comments" className="bg-[#151522] border border-white/10 rounded-2xl p-6 hover:bg-[#1c1c2b] transition">
