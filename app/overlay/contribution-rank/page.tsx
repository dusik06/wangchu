...
export default function ContributionRankOverlay() {
  ...
  return (
    <main className="min-h-screen bg-transparent p-2 font-sans text-white" style={{ backgroundColor:"rgba(0,0,0,0)" }}>
      <style>{`html,body,body>div,#__next{background:transparent!important;background-color:rgba(0,0,0,0)!important;} body>header,body>nav,body>footer,body>div>header,body>div>nav,body>div>footer{display:none!important;}`}</style>
